...
_G.packer_plugins = {
  ...
  ["nvim-ts-autotag"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/kali/.local/share/nvim/site/pack/packer/opt/nvim-ts-autotag",
  ...
  ["typescript.nvim"] = {
    loaded = true,
    path = "/home/kali/.local/share/nvim/site/pack/packer/start/typescript.nvim",
  ...
  ["vim-nightfly-guicolors"] = {
    loaded = true,
    path = "/home/kali/.local/share/nvim/site/pack/packer/start/vim-nightfly-guicolors",
